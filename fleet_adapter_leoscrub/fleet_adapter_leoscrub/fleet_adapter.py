        ...
        while len(missing_robots) > 0:
            ...
            for robot_name in list(missing_robots.keys()):
                ...
                if robot_position_rmf.orientation_radians is not None:
                    ...
                    changemap_response = api.change_map(robot_name=robot_name, map_name=rmf_config['start']['map_name'])

                    if changemap_response is False:
                    ...
                    dock_home_position: LionsbotCoord = LionsbotCoord.from_coord_arr(LionsbotCoord(
                    ...
                    while True:
                        if api.get_robot_status(robot_name=robot_name)['localized']:
                            ...
                            is_localized = api.localize(position=dock_home_position, 
